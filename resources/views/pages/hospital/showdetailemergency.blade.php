        ...
        <div class="col-md-8">
             <div class="card">
                ...
                <div class="card-body p-0" style="position:relative;">
                    <div id="map"></div>
                    <!-- Directions Panel -->
                    <div id="directionsPanel" style="display:none; position:absolute; top:10px; left:10px; width:340px; max-height:90%; background:#fff; border-radius:8px; box-shadow:0 4px 15px rgba(0,0,0,0.2); z-index:999; flex-direction:column; overflow:hidden;">
                        <div class="dp-header">
                            <div class="dp-header-title">
                                <i class="fas fa-directions"></i> Driving Directions
                            </div>
                            <button class="dp-close-btn" onclick="document.getElementById('directionsPanel').style.display='none'; if(typeof directionsRenderer !== 'undefined') directionsRenderer.setDirections({routes:[]});">
                        ...
                        <div class="dp-summary" id="dpSummary">
                            <div>
                                ...
                                <div class="val" id="dpDistance">—</div>
                            </div>
                            <div>
                                <span class="label">Est. Time</span>
                                <div class="val" id="dpDuration">—</div>
                            </div>
                        </div>
    ...
    function setupFilterControl() {
        ...
        container.innerHTML = `
            ...
            <div id="hospitalFilter" style="display:none;">
                ...
                ${['National (CPA3+)','Provincial (CPA3) / District (CPA2)','Primary','Large Hospital','Medium Hospital / Polyclinic','Medium Hospital / Polyclinic']
