...
@section('page-title', 'Cambodia Police')
...
<style>
    ...
    .emergency-legend .airport-list { width: 100%; }
    ...
    .emergency-legend .legend-medical-grid > .class-column { min-width: 0; }
    .emergency-legend .legend-medical-grid .hospital-item { width: 100%; }
    .emergency-legend .legend-medical-grid .hospital-item .btn { width: 100% !important; }
    ...
    /* Wide detail modals, matching the dashboard layout. */
    .wide-detail-modal .modal-dialog,
    .medical-facility-modal .modal-dialog {
        width: calc(100% - 12px);
        max-width: 1200px;
    }

    .wide-detail-modal .modal-content,
    ...
    .medical-facility-modal .tab-content h5 {
        font-size: 18px;
    }

    .medical-facility-modal .tab-content h6 {
        font-size: 14px;
    }

    .medical-facility-modal .tab-content p {
        margin-bottom: 14px;
    }
...
<div class="modal fade wide-detail-modal" id="police1Modal" tabindex="-1" aria-labelledby="disclaimerLabel" aria-hidden="true">
...
<div class="modal fade wide-detail-modal" id="police2Modal" tabindex="-1" aria-labelledby="disclaimerLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <div class="d-flex align-items-center">
...
<div class="modal fade wide-detail-modal" id="police3Modal" tabindex="-1" aria-labelledby="disclaimerLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <div class="d-flex align-items-center">
...
<div class="modal fade wide-detail-modal" id="police4Modal" tabindex="-1" aria-labelledby="disclaimerLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <div class="d-flex align-items-center">
